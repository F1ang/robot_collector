...
static float B[6]={0.980358187761106,-0.0105514731414606,0.00754899338354401,0.950648704823113,-0.0354995317649016,1.07449478456729};
...
uint8_t MPU_Init_Call(void)
{
  ...
  MPU_Set_Rate(200);						       	 	//设置采样率200Hz=5ms
...
//返回值:0,设置成功
//    其他,设置失败 
uint16_t MPU_Set_Rate(uint16_t rate)
{
	uint8_t data;
