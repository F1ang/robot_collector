...
void MX_FREERTOS_Init(void) {
  ...
  /* Create the thread(s) */
  /* definition and creation of LOGGER_TASK */
  osThreadDef(LOGGER_TASK, Logger_Task, osPriorityNormal, 0, 128);
  LOGGER_TASKHandle = osThreadCreate(osThread(LOGGER_TASK), NULL);
