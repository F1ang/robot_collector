...
{
    bsp_adc.Ia = (float)HAL_ADCEx_InjectedGetValue(&hadc1, ADC_INJECTED_RANK_1) / 32768 * 3.3f / 0.02f / 10; // 获取注入通道值
    bsp_adc.Ib = (float)HAL_ADCEx_InjectedGetValue(&hadc1, ADC_INJECTED_RANK_2) / 32768 * 3.3f / 0.02f / 10;
