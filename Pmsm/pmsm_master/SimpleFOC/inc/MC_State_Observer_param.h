...
#define K1 (s32)(-23213)             /* State Observer Gain 1 */
// Values showed on LCD display must be here multiplied by 100 
#define K2 (s32)(91230)             /* State Observer Gain 2 */
...
#define FIRST_I_STARTUP           (u16) 958
#define FINAL_I_STARTUP           (u16) 1118
...
#define SLESS_I_ALIGNMENT           (u16) 3113
