...
#define PID_SPEED_REFERENCE_RPM   (s16)1000
#define PID_SPEED_KP_DEFAULT      (s16)450
#define PID_SPEED_KI_DEFAULT      (s16)150
#define PID_SPEED_KD_DEFAULT      (s16)5

/* Speed PID parameter dividers          */
#define SP_KPDIV ((u16)(32))
#define SP_KIDIV ((u16)(512))
#define SP_KDDIV ((u16)(64))
...
#define PID_TORQUE_KP_DEFAULT  (s16)557
...
#define PID_FLUX_KP_DEFAULT  (s16)557
