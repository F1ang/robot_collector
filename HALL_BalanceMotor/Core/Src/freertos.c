...
osSemaphoreId imu_semaHandle;
osSemaphoreId move_semaHandle;
...
void MX_FREERTOS_Init(void) {
  ...
  /* definition and creation of imu_sema */
  osSemaphoreDef(imu_sema);
  imu_semaHandle = osSemaphoreCreate(osSemaphore(imu_sema), 1);

  /* definition and creation of move_sema */
  osSemaphoreDef(move_sema);
  move_semaHandle = osSemaphoreCreate(osSemaphore(move_sema), 1);
