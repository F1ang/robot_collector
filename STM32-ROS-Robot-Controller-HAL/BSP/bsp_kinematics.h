...
#define ENCODER_RESOLUTION 1320.0 //编码器分辨率, 轮子转一圈，编码器产生的脉冲数(编码器分辨率：11*30*4（11线，1：30减速比，四倍频）)
#define WHEEL_DIAMETER 0.065 //轮子直径,单位：米m  65mm
#define D_X 0.157 //底盘Y轴上两轮中心的间距
#define D_Y 0.125 //底盘X轴上两轮中心的间距
...
#define ROBOT_LINEAR_SPEED_LIMIT 1000   //机器人线速度限值 m/s*1000
#define ROBOT_ANGULAR_SPEED_LIMIT 1000  //机器人角速度限值 rad/s*1000

#define ENCODER_MAX 32767        
#define ENCODER_MIN -32768 
#define ENCODER_LOW_WRAP  ((ENCODER_MAX - ENCODER_MIN)*0.3+ENCODER_MIN)				//-13107.5
#define ENCODER_HIGH_WRAP ((ENCODER_MAX - ENCODER_MIN)*0.7+ENCODER_MIN)				//13106.5
#define PI 3.1415926
